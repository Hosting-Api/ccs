            ...
            <section className="bg-white dark:bg-gray-100">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        ...
                        <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-600">
                    ...
                    <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                        {/* <!-- Pricing Card --> */}
                        {/* <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-green-600 xl:p-8 dark:bg-gray-100 dark:text-black"> */}
                        <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-[#ffc56e] xl:p-8 dark:bg-gray-100 dark:text-black">
